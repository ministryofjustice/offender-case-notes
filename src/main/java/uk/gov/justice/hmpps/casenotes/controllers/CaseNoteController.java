...
public class CaseNoteController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "The Case Note has been recorded. The updated object is returned including the status.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CaseNote.class))}),
            @ApiResponse(responseCode = "404", description = "No case notes where found for this offender and case note id", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))})})
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "200", description = "OK", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CaseNoteTypeDto.class))})})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "The Case Note Type has been recorded. The updated object is returned including the status.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CaseNoteTypeDto.class))}),
            @ApiResponse(responseCode = "409", description = "The case note type has already been recorded. The current unmodified object (including status) is returned.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))})})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "The Case Note Sub Type has been recorded. The updated object is returned including the status.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CaseNoteTypeDto.class))}),
            @ApiResponse(responseCode = "409", description = "The case note sub type has already been recorded. The current unmodified object (including status) is returned.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))})})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "The case note type has been updated. The updated object is returned.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CaseNoteTypeDto.class))}),
            @ApiResponse(responseCode = "404", description = "The case note type is not found", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))})})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "The case note sub type update has been updated. The updated object is returned.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = CaseNoteTypeDto.class))}),
            @ApiResponse(responseCode = "404", description = "The case note sub type is not found", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))})})
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Deletes a case note", description = "delete case note")
    @ApiResponses({
            @ApiResponse(responseCode = "404", description = "Offender or case note not found")})
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Deletes a case note amendment", description = "delete case note amendment")
    @ApiResponses({
            @ApiResponse(responseCode = "404", description = "Offender or case note not found")})
