...
INSERT INTO OFFENDER_CASE_NOTE (OFFENDER_CASE_NOTE_ID, OFFENDER_IDENTIFIER, LOCATION_ID, AUTHOR_USERNAME, AUTHOR_NAME, CASE_NOTE_TYPE_ID,OCCURRENCE_DATE_TIME,
                                NOTE_TEXT, CREATE_DATE_TIME, CREATE_USER_ID, MODIFY_DATE_TIME, MODIFY_USER_ID, LEGACY_ID, AUTHOR_USER_ID, SOFT_DELETED)
VALUES ('b5aa1318-e874-4614-a80d-a514e84d1a52', 'L6962XX', 'WNI', 'ADAM_GEN', 'John Smith', (select case_note_type_id from case_note_type where parent_type = 'POM' and sub_type = 'GEN'),
        '2019-08-29 17:08:46.188956', 'text','2019-08-29 17:08:46.655233','ADAM_GEN','2019-08-29 17:08:46.655233','ADAM_GEN', nextval('offender_case_note_event_id_seq'), 'ADAM_GEN', 'FALSE');
...
VALUES ('b5aa1318-e874-4614-a80d-a514e84d1a53', 'L6962XX', 'WNI', 'ADAM_GEN', 'John Smith', (select case_note_type_id from case_note_type where parent_type = 'POM' and sub_type = 'GEN'),
        '2022-07-29 11:08:46.655233', 'text1','2022-07-29 11:08:46.655233','ADAM_GEN','2022-07-29 11:08:46.655233','ADAM_GEN', nextval('offender_case_note_event_id_seq'), 'ADAM_GEN', 'FALSE');
...
VALUES ('b5aa1318-e874-4614-a80d-a514e84d1a54', 'L6962XX', 'WNI', 'ADAM_GEN', 'John Smith', (select case_note_type_id from case_note_type where parent_type = 'POM' and sub_type = 'GEN'),
        '2023-07-29 17:08:46.655233', 'text33','2023-07-29 17:08:46.655233','ADAM_GEN','2023-07-29 17:08:46.655233','ADAM_GEN', nextval('offender_case_note_event_id_seq'), 'ADAM_GEN', 'FALSE');
...
VALUES ('b5aa1318-e874-4614-a80d-a514e84d1a55', 'L6962XX', 'WNI', 'ADAM_GEN', 'John Smith', (select case_note_type_id from case_note_type where parent_type = 'POM' and sub_type = 'GEN'),
        '2023-11-29 17:08:46.655233', 'text4','2023-11-29 17:08:46.655233','ADAM_GEN','2023-11-29 17:08:46.655233','ADAM_GEN', nextval('offender_case_note_event_id_seq'), 'ADAM_GEN', 'FALSE');
...
VALUES ('b5aa1318-e874-4614-a80d-a514e84d1a56', 'L6962XX', 'WNI', 'ADAM_GEN', 'John Smith', (select case_note_type_id from case_note_type where parent_type = 'POM' and sub_type = 'GEN'),
        '2023-12-30 17:08:46.655233', 'text6','2023-12-30 17:08:46.655233','ADAM_GEN','2023-12-30 17:08:46.655233','ADAM_GEN', nextval('offender_case_note_event_id_seq'), 'ADAM_GEN', 'FALSE');
...
VALUES (gen_random_uuid(), 'b5aa1318-e874-4614-a80d-a514e84d1a54','ADAM_GEN','John Smith','Note amendment1','2023-12-29 17:08:46.655233','ADAM_GEN','2023-07-29 17:08:46.655233',
...
INSERT INTO OFFENDER_CASE_NOTE_AMENDMENT (OFFENDER_CASE_NOTE_AMENDMENT_ID, OFFENDER_CASE_NOTE_ID, AUTHOR_USERNAME,
                                          AUTHOR_NAME, NOTE_TEXT, CREATE_DATE_TIME, CREATE_USER_ID, MODIFY_DATE_TIME,
                                          MODIFY_USER_ID, AUTHOR_USER_ID, SOFT_DELETED)
VALUES (gen_random_uuid(), 'b5aa1318-e874-4614-a80d-a514e84d1a54','ADAM_GEN','John Smith','Note amendment2','2024-01-29 17:08:46.655233','ADAM_GEN','2024-01-29 17:08:46.655233',
        'ADAM_GEN','ADAM_GEN', 'FALSE');

INSERT INTO OFFENDER_CASE_NOTE_AMENDMENT (OFFENDER_CASE_NOTE_AMENDMENT_ID, OFFENDER_CASE_NOTE_ID, AUTHOR_USERNAME,
                                          AUTHOR_NAME, NOTE_TEXT, CREATE_DATE_TIME, CREATE_USER_ID, MODIFY_DATE_TIME,
                                          MODIFY_USER_ID, AUTHOR_USER_ID, SOFT_DELETED)
VALUES (gen_random_uuid(), 'b5aa1318-e874-4614-a80d-a514e84d1a56','ADAM_GEN','John Smith','New amendment1','2023-12-31 17:08:46.655233','ADAM_GEN','2023-12-31 17:08:46.655233',
        'ADAM_GEN','ADAM_GEN', 'FALSE');
