...
(
    ...
    FOREIGN KEY (CASE_NOTE_TYPE_ID) REFERENCES CASE_NOTE_TYPE (CASE_NOTE_TYPE_ID)
);
...
CREATE INDEX OFFENDER_CASE_NOTE_IDX3 ON OFFENDER_CASE_NOTE (AUTHOR_USERNAME);

CREATE INDEX OFFENDER_CASE_NOTE_IDX4 ON OFFENDER_CASE_NOTE (CASE_NOTE_TYPE_ID);
